            ...
            <div className="card md:p-10 bg-base-100 w-full max-w-lg shrink-0 rounded-sm">
                ...
                <form onSubmit={handleOnSubmit} className="card-body">
                    ...
                    <div className="form-control space-y-2 flex flex-col">
                        ...
                        <input name='name' type="text" placeholder="Enter your name" className="input input-bordered w-full border-none bg-gray-200" required />
                    </div>
                    ...
                    <div className="form-control pt-4 space-y-2 flex flex-col">
                        ...
                        <input name='photo' type="text" placeholder="Enter your photo URL" className="input input-bordered w-full border-none bg-gray-200" required />
                    </div>
